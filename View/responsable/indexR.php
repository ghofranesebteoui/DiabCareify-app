...
<style>
    * {
    ...
    .main {
        width: 100%;
        height: 100vh;
        background: linear-gradient(to top, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('../images/adminbis.png') center/cover no-repeat;
        display: flex;
        align-items: center;
...
<body>
    ...
    <div class="main">
        <div>
            <h1 class="animate__animated animate__fadeInDown">Bienvenue dans l'espace Responsable de notre application <br>de gestion du taux des diabétiques et hypertendus dépistés <br> au stade de complication.</h1>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h4 class="title"><a href="">Taux de Détection</a></h4>
                            <p class="description">Pourcentage des cas de diabète dépistés au stade de complication.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h4 class="title"><a href="">Suivi Mensuel</a></h4>
                            <p class="description">Fréquence de suivi des indicateurs sur une base mensuelle.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            <div class="icon"><i class="fas fa-shield-heart"></i>

                            </div>
                            <h4 class="title"><a href="">Prévention</a></h4>
                            <p class="description">Mesures prises pour réduire les complications liées à l'hypertension.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <h4 class="title"><a href="">Rapports Statistiques</a></h4>
                            <p class="description">Données consolidées pour l'analyse des indicateurs.</p>
                        </div>
                    </div>
                </div>
