    ...
    <style>
        * {
        ...
        .main {
            width: 100%;
            height: 100vh;
            background: linear-gradient(to top, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('../images/admin4.png') center/cover no-repeat;
            display: flex;
            align-items: center;
            color: #fff;
            padding: 0 10%;
...
<body>
    ...
    <div class="container">
        <h1>Suivi des Unités d'Organisation (UOs)</h1>
        ...
        <table>
            ...
            <tbody>
                <?php if (isset($suiviUOs) && !empty($suiviUOs)): ?>
                    <?php foreach ($suiviUOs as $uo): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($uo['uo_nom']); ?></td>
                            <td><?php echo htmlspecialchars($uo['date_debut']); ?></td>
                            <td><?php echo htmlspecialchars($uo['date_fin']); ?></td>
                            <td><?php echo htmlspecialchars($uo['statut']); ?></td>
                            <td><?php echo htmlspecialchars($uo['statut_saisie']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
